    ...
    <section className="pt-8 w-full">
      <div className="w-full flex flex-col gap-6 animate-fade-in p-6">
        ...
        <div className="grid max-xl:grid-cols-1 grid-cols-2 self-center gap-25">
          ...
          // class="flex gap-4 overflow-hidden scroll-smooth snap-x snap-mandatory" //
          <Card className="grid gap-4 items-center max-w-3xl [grid-template-areas:'foto''texto''botao'] lg:[grid-template-areas:'foto_texto''botao_botao'] lg:grid-cols-[auto_1fr]">
            <div className="[grid-area:foto] justify-self-center h-64">
            ...
            <div className="[grid-area:texto] flex flex-col gap-4 max-lg:text-center">
              ...
              <p>
                Opa meu nome é Marcos sou conhecido como marco, tenho 20 anos e sou estudante de ADS gosto muito de aprender sobre programação.<br></br>
                <br></br>
                Sobre mim sou um pouco extrovertido, gosto de socializar as vezes. minha linguagem favorita é Java.<br></br>
                <br></br>
                gosto muito de aprender sobre ferramentas e frameworks diferentes, também me interesso por Gadgets.<br></br>
                <br></br>
                quero estar melhorando cada vez mais minha percepeção sobre a lógica e algoritmos para que eu seja um bom programador.<br></br>
                <br></br>
                meu sonho é ser um programador back-end mas que faz a parte de cybersegurança também.<br></br>
              </p>
            </div>
            <div className="[grid-area:botao] flex justify-around">
