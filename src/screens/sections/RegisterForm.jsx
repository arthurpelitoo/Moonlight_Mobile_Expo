...
import {
  AddressBookIcon, ArrowRightIcon, CheckIcon, EnvelopeIcon,
  EyeIcon, EyeSlashIcon, LockKeyIcon, UserIcon,
...
export function RegisterForm() {
  ...
  return (
    <View style={styles.form}>
      <InputFieldForm
        id="reg-name" label="Nome de usuário"
      ...
      <InputFieldForm
        id="reg-cpf" label="CPF" inputMode="numeric"
      ...
      <InputFieldForm
        ...
        rightElement={
          <Button variant="transparent" onPress={toggleShowPassword} style={styles.eyeButton}>
            {ui.showPassword ? <EyeSlashIcon size={18} color={COLORS.textSubtle} /> : <EyeIcon size={18} color={COLORS.textSubtle} />}
          </Button>
        }
      />
      ...
      <InputFieldForm
        ...
        rightElement={
          <Button variant="transparent" onPress={toggleShowConfirm} style={styles.eyeButton}>
            {ui.showConfirm ? <EyeSlashIcon size={18} color={COLORS.textSubtle} /> : <EyeIcon size={18} color={COLORS.textSubtle} />}
          </Button>
        }
      />
      <FieldVerify
      ...
      <Button variant="primary" disabled={ui.loading} onPress={handleSubmit} style={styles.submitButton}>
      ...
      <View style={styles.loginRow}>
        ...
        <Button variant="transparent" onPress={() => router.replace('/pages/Customer/Auth/Login/LoginPage')}>
...
const styles = StyleSheet.create({
  form: { gap: 4 },
  successWrap: { alignItems: 'center', gap: 16, paddingVertical: 32 },
  successCircle: { width: 64, height: 64, borderRadius: 32, borderWidth: 1, borderColor: 'rgba(255,255,255,0.2)', alignItems: 'center', justifyContent: 'center' },
  successTitle: { color: COLORS.text, fontFamily: FONTS.regular, fontSize: 16, letterSpacing: 1 },
  eyeButton: { padding: 4, backgroundColor: 'rgba(255,255,255,0.05)', borderWidth: 1, borderColor: COLORS.border, borderRadius: 6 },
  apiError: { color: COLORS.danger, fontFamily: FONTS.regular, fontSize: 13, textAlign: 'center', marginTop: 4 },
  submitButton: { marginTop: 8 },
  submitContent: { flexDirection: 'row', alignItems: 'center', gap: 8 },
  submitText: { color: '#fff', fontFamily: FONTS.semiBold, fontSize: 13, letterSpacing: 1, textTransform: 'uppercase' },
  loginRow: { flexDirection: 'row', justifyContent: 'center', alignItems: 'center', marginTop: 4 },
  loginText: { color: 'rgba(255,255,255,0.3)', fontFamily: FONTS.regular, fontSize: 11 },
  loginLink: { color: COLORS.indigo, fontFamily: FONTS.regular, fontSize: 11 },
});
